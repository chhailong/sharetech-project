...
import ProductDetail from './components/JS/Products/ProductDetail';
  ...
  return (
      ...
      <div className="App">
        ...
        <Routes>
          ...
          <Route  path="/products/detail/asus-zephyrus" element ={<ProductDetail product="AsusZephyrus ASUS"/>}></Route>
          <Route  path="/products/detail/dell-inspriron" element ={<ProductDetail product="DellInspiron"/>}></Route>
